 ...
 * @author ALEX
 */
public class TesteCalc extends javax.swing.JFrame {

/**
 * Creates new form TesteCalc
 */
public TesteCalc() {
  initComponents();
}
...
@SuppressWarnings("unchecked")
  ...
  private void initComponents() {
    ...
    jLabel2.setText("Digite Outro Número");
...
public static void main(String args[]) {
  ...
  try {
    ...
    java.util.logging.Logger.getLogger(TesteCalc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
